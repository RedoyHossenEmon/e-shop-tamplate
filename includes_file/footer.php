  ...
  <!-- Footer-->
    <footer class="footer bg-dark pt-5">
        ...
        <div class="row pb-2">
          ...
          <div class="col-md-4">
            <div class="widget pb-2 mb-4">
              ...
              <form class="subscription-form validate" action="../external.html?link=https://studio.us12.list-manage.com/subscribe/post?u=c7103e2c981361a6639545bd5&amp;amp;id=29ca296126" method="post" name="mc-embedded-subscribe-form" target="_blank" novalidate>
      ...
      <div class="pt-5 bg-darker">
        <div class="container">
          ...
          <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made by <a class="text-light" href="../external.html?link=https://createx.studio/" target="_blank" rel="noopener">Createx Studio</a></div>
        </div>
      </div>
    </footer>
    ...
    <div class="handheld-toolbar">
      ...
      <a class="d-table-cell handheld-toolbar-item" href="shop-cart.html">
        ...
        <span class="handheld-toolbar-label">$265.00</span></a>
  </div>
    </div>
    <!-- Back To Top Button-->
...
function ajaxRequest(reqtype = null, reqvalue = null) {
  
  
  $.ajax({
    url: 'http://localhost/e-shop/includes_file/product-list.php',
    method: 'GET',
    data:{type :reqtype , value : reqvalue },
    dataType: 'json',
 ...
 var resultDiv = $('#product-list-wrapp');

  $(".widget-list-link").click(function() {

   var reqtype = "stylename";
   var reqvalue = $(this).find(".widget-filter-item-text").text();

    if(reqvalue == "View all"){
      reqtype = "cetagoryname";
      reqvalue = $(this).parents(".accordion-item").find('.accordion-button').text();
      }
      ajaxRequest(reqtype,reqvalue);
...
// $("#brand-filter li -input").change(function(){
//   var attr =$(this).parents().find('.form-check-label').text()
//   console.log(attr);
// })
// $('#brand-filter li input').change(function () {
...
//               var labelText += $('label[for='+ idss+']').text();
...
//     url: 'http://localhost/e-shop/includes_file/product-list.php',
//     method: 'GET',
//     data:{type :"brand" , value : checkedCheckboxes },
//     dataType: 'json',
//     success: function(response) {
//       resultDiv.empty()
//         resultDiv.append(response);
